...
#print(m)
    ...
    if m[1]=="nokta" and m[2]=="nokta" and m[3]=="çizgi" and m[4]=="nokta" and m[5]=="nokta" and m[6]=="nokta" and m[7]=="nokta" and m[8]=="çizgi"and m[9]=="çizgi" and m[10]=="karakter" and m[11]=="":
        harf="b"
        hh=hh+1
        kelime[hh]="b"
        print(harf)
    ...
    if m[1]=="nokta" and m[2]=="nokta" and m[3]=="nokta" and m[4]=="çizgi" and m[5]=="nokta" and m[6]=="nokta" and m[7]=="çizgi" and m[8]=="nokta" and m[9]=="nokta" and m[10]=="çizgi"and m[11]=="çizgi" and m[12]=="karakter" and m[13]=="":
        ...
        m=["","","","","","","","","","","","","","",""]
        i=i+1
    if m[1]=="nokta" and m[2]=="nokta" and m[3]=="çizgi" and m[4]=="nokta" and m[5]=="nokta" and m[6]=="nokta" and m[7]=="nokta" and m[8]=="nokta" and m[9]=="nokta" and m[10]=="çizgi"and m[11]=="çizgi" and m[12]=="karakter" and m[13]=="":
        harf="x"
        hh=hh+1
        kelime[hh]="x"
        print(harf)
